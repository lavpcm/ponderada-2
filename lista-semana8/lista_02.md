...
A) Ambas as funções exibirão: 'Seu crédito foi aprovado. Saldo disponível: 400.' ``CORRETA: ambas as funções fazem a mesma coisa mas utilizam comandos diferentes`` 
